...
| RESULTS | The results are organized clearly.  The review compares the results from 10-15 academic sources.  The sources are critically appraised and synthesized concisely. | The results are organized well.  The review compares the results from at least 10 academic sources.  Most of the sources are critically appraised and the information is synthesized well. | The results are somewhat organized. The review compares the results from less than 10 academic sources. The sources are not critically appraised and the information is synthesized well. | The results are not organized. The review does not compare the results from at least 10 academic sources. The sources are not critically appraised and the information is not synthesized. |
