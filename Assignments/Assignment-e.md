...
At the very end list your references.  Reference lists must start on a new page, and must be formatted as per APA 6 guidelines according to which type of literature is being cited \(i.e., book by one author, book with an editor, journal article, blog and so forth\).
...
| METHODS | The process for how articles were selected and critically analyzed is clear and specific details are provided. | The process for how articles were selected and critically analyzed is mostly clear and most details are provided. | The process for how articles were selected and critically analyzed is not clear. Some specific details are provided. | The process for how articles were selected and critically analyzed is not clear and no specific details are provided. |
| RESULTS | The results are organized clearly.  The review compares the results from 10-15 academic sources.  The sources are critically appraised and synthesized concisely. | The results are organized well.  The review compares the results from at least 10 academic sources.  Most of the sources are critically appraised and the information is synthesized. | The results are somewhat organized. The review compares the results from less than 10 academic sources. The sources are not critically appraised and the information is summarized. | The results are not organized. The review does not compare the results from at least 10 academic sources. The sources are not critically appraised and the information is summarized. |
| DISCUSSION/CONCLUSION | A concise summary is provided.  The strengths and weakness and limitations are addressed.  The conclusion clearly connects to the research question and future research directions are recommended. | A summary is provided. The strengths and weakness are addressed. The conclusion connects to the research question and future research directions are recommended. | A summary is provided. The strengths and weakness are not addressed. The conclusion connects to the research question and no future research directions are recommended. | A summary is not provided. The strengths and weakness are not addressed. The conclusion does not connect to the research question and no future research directions are recommended. |
