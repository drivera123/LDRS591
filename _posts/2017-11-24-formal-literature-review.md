...
---
<h3>Formal Literature Review</h3>
...
<thead>
<tr>
  <th align="left">Quality Criteria</th>
  <th align="left">Indicators of high quality (+)</th>
  <th align="left">Indicators of low quality (-)</th>
</tr>
</thead>
<tbody>
<tr>
  <td align="left">For quantitative studies (QNT)</td>
  <td align="left">Clearly focused study, sufficient background provided, well planned, method is appropriate, measures validated, adequate number of participants, data analysis rigorous with adequate statistical methods, findings and limitations are clearly stated.</td>
  <td align="left">Not focused, insufficient background provided, poorly planned, inappropriate method, invalidated measures, inadequate number of participants, data analysis not rigorous, inadequate statistical methods, unclear findings and limitations.</td>
</tr>
<tr>
  <td align="left">For qualitative studies (QAL)</td>
  <td align="left">Purpose stated clearly, relevant background literature reviewed, design appropriate, identified researcher's theoretical or philosophical perspective, relevant and well described selection of participants and context, procedural rigour in data collection strategies and analysis, evidence of the four components of trustworthiness (credibility, transferability, dependability, and confirmability) results are comprehensive and well described.</td>
  <td align="left">Vague purpose, insufficient background, few or unsatisfactory descriptions of participants and context, trustworthiness inadequately addressed, lacks description of data collection, data analysis and results.</td>
</tr>
</tbody>
</table>
...
<thead>
<tr>
  <th align="left">LDRS 591 FORMAL LITERATURE REVIEW EVALUATION</th>
  <th align="left">Outstanding15 points</th>
  <th align="left">Good 10 points</th>
  <th align="left">Acceptable 5 points</th>
  <th align="left">Inadequate/Missing 0 points</th>
</tr>
</thead>
<tbody>
<tr>
  <td align="left">TITLE PAGE</td>
  <td align="left">Includes running head, specific and informative title, author, course code, institution and date.</td>
  <td align="left">Omits one of the previous</td>
  <td align="left">Omits two of the previous</td>
  <td align="left">Omits three or more of the previous</td>
</tr>
<tr>
  <td align="left">ABSTRACT</td>
  <td align="left">Clearly states the purpose/question, literature review criteria, results, important conclusions.</td>
  <td align="left">Purpose/question are stated clearly, other points are not included.</td>
  <td align="left">Purpose/question are not stated, other points are included.</td>
  <td align="left">Purpose/question is not clearly stated, other points are not included.</td>
</tr>
<tr>
  <td align="left">INTRODUCTION</td>
  <td align="left">Aim and scope are clearlyprovided using the following rationale: a broad context, relevant statistics, importance of addressing the problem, and defining key terms. Purpose and research question are clearly identified.</td>
  <td align="left">Aim and scope are provided, rationale is not explained. Purpose and research question are clearly stated.</td>
  <td align="left">The topic is introduced, rationale is explained. Purpose and research question are not clear.</td>
  <td align="left">The topic is not introduced, the rationale is not explained, and the purpose and research question are not clear.</td>
</tr>
<tr>
  <td align="left">METHODS</td>
  <td align="left">The process for how articles were selected and critically analyzed is clear and specific details are provided.</td>
  <td align="left">The process for how articles were selected and critically analyzed is mostly clear and most details are provided.</td>
  <td align="left">The process for how articles were selected and critically analyzed is not clear. Some specific details are provided.</td>
  <td align="left">The process for how articles were selected and critically analyzed is not clear and no specific details are provided.</td>
</tr>
<tr>
  <td align="left">RESULTS</td>
  <td align="left">The results are organized clearly. The review compares the results from 10-15 academic sources. The sources are critically appraised and synthesized concisely.</td>
  <td align="left">The results are organized well. The review compares the results from at least 10 academic sources. Most of the sources are critically appraised and the information is synthesized.</td>
  <td align="left">The results are somewhat organized. The review compares the results from less than 10 academic sources. The sources are not critically appraised and the information is summarized.</td>
  <td align="left">The results are not organized. The review does not compare the results from at least 10 academic sources. The sources are not critically appraised and the information is summarized.</td>
</tr>
<tr>
  <td align="left">DISCUSSION/CONCLUSION</td>
  <td align="left">A concise summary is provided. The strengths and weakness and limitations are addressed. The conclusion clearly connects to the research question and future research directions are recommended.</td>
  <td align="left">A summary is provided. The strengths and weakness are addressed. The conclusion connects to the research question and future research directions are recommended.</td>
  <td align="left">A summary is provided. The strengths and weakness are not addressed. The conclusion connects to the research question and no future research directions are recommended.</td>
  <td align="left">A summary is not provided. The strengths and weakness are not addressed. The conclusion does not connect to the research question and no future research directions are recommended.</td>
</tr>
<tr>
  <td align="left">REFERENCES</td>
  <td align="left">Information in cited properly in APA format.</td>
  <td align="left">Information is cited properly, but has a 2-3 errors.</td>
  <td align="left">Information is cited properly, but has 4+ errors.</td>
  <td align="left">Information is not cited properly.</td>
</tr>
<tr>
  <td align="left">GENERAL WRITING STYLE &amp; PRESENTATION</td>
  <td align="left">Adheres to the 10 page minimum criteria. There are 2 or less grammatical/spelling errors. The paper is clearly organized using headings, and the readability of is excellent.</td>
  <td align="left">Is under 10 pages by half a page or less. There are 3- 4 grammatical or spelling errors. The paper is organized well with headings and the readability of the paper is very good.</td>
  <td align="left">Is under 10 pages by one page. There are 4-5 grammatical or spelling errors. The paper is organized with headings and the readability of the paper is good.</td>
  <td align="left">Does not meet 10 page criteria. There are 6 or more grammatical or spelling errors. The paper is not organized welland the readability of the paper is poor.</td>
</tr>
</tbody>
</table>
