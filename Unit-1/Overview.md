...
In this first unit, we will set the stage for our work in LDRS 591 by first looking at the reason the course LDRS 591 even exists:  to support the program capstone, the Learning Integration Project \(LDRS 697/698\). 
